...
#ifndef GEOCONFORM_FREEIMAGE_H
#define GEOCONFORM_FREEIMAGE_H
...
IMTimage ImthresholdGetData(FIBITMAP*, IMTimage);
void ImthresholdSetData(FIBITMAP*, IMTimage);
IMTimage ImthresholdGetDataBW(FIBITMAP*, IMTimage);
void ImthresholdSetDataBW(FIBITMAP*, IMTimage);
